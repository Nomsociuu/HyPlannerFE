        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <Text
            style={[
              ...
              {
                color:
                  totalExpectedBudget > totalBudget ? "#D95D74" : "#6B7280",
              },
            ]}
          >
            Ngân sách dự kiến: {totalExpectedBudget.toLocaleString()} /{" "}
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <Text
            style={[
              styles.progressText,
              {
                color: totalActualBudget > totalBudget ? "#D95D74" : "#6B7280",
              },
            ]}
          >
            Ngân sách thực tế: {totalActualBudget.toLocaleString()} /{" "}
            {totalBudget.toLocaleString()} VNĐ
          </Text>
        </View>
