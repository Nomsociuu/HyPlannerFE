  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        <View style={[styles.popup, { backgroundColor: getBackgroundColor(), borderColor: getBorderColor() }]}>
          ...
          {type !== 'warning' && typeof buttonText === 'string' && (
            <TouchableOpacity
              style={[styles.button, { backgroundColor: type === 'success' ? '#10B981' : type === 'error' ? '#EF4444' : '#F59E0B' }]}
