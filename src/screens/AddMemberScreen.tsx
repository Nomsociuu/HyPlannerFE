...
// // --- Kiểu dữ liệu và Dữ liệu giả lập ---
// // type Member = {
// //     id: string
// //     name: string
// //     email: string
...
// //         avatar: 'https://i.pravatar.cc/150?u=ngoctram',
// //     },
// //     {
// //         id: '4',
// //         name: 'Khánh Linh',
...
// //         id: '5',
// //         name: 'Đức Trí',
// //         email: 'ductri@gmail.com',
// //         avatar: 'https://i.pravatar.cc/150?u=ductri',
// //     },
// //     {
// //         id: '6',
// //         name: 'Đức Trí',
...
// //         avatar: 'https://i.pravatar.cc/150?u=nguyenvanb',
// //     },
// //     {
// //         id: '9',
// //         name: 'Nguyễn Văn C',
// //         email: 'nguyenvanc@gmail.com',
// //         avatar: 'https://i.pravatar.cc/150?u=nguyenvanc',
// //     },
// // ]
...
//     const memberInTask = useSelector((state: RootState) => state.tasks.getTaskInfo.task?.member) || []; // use for edit task

//     const availableMembers = useMemo(() => {
//         return recentMembers.filter(
//             (eventMember) => !memberInTask.some((taskMember) => taskMember._id === eventMember._id)
//         );
//     }, [recentMembers, memberInTask]);
//     // const recentMembers: Member[] = useMemo(() =>
...
//         // Chỉ thêm nếu thành viên chưa được chọn
...
//         >
//             <AddMemberAppbar onBack={handleBack} />
...
//                 {/* --- Khu vực hiển thị thành viên đã chọn --- */}
//                 <Text style={styles.listTitle}>Chọn thành viên {selectedMembers.length > 0 ? `(${selectedMembers.length})` : ''}</Text>
...
//     const availableMembers = useMemo(() => {
//         return recentMembers.filter(
//             (user) => !existingMembers.some((ex) => ex._id === user._id)
//         );
