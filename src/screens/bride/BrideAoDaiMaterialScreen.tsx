  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: topPad }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Áo dài - Chất liệu</Text>
      </View>
          ...
          {items.map((it) => (
            <View style={{ width: ITEM_WIDTH }} key={it._id}>
              <WeddingItemCard
                ...
                name={it.name}
                image={it.image}
                isSelected={selectedBrideEngageMaterials.includes(it._id)}
                onSelect={async () => await toggleBrideEngageMaterial(it._id)}
              />
            </View>
          ))}
        </View>
...
const styles = StyleSheet.create({
  ...
  actionButton: {
    ...
    justifyContent: "center",
    alignSelf: "center",
    width: "65%", // Tăng width lên một chút vì text dài
    flexDirection: "row",
  },
  actionButtonText: {
    color: "#000",
