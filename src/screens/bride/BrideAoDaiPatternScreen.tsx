    ...
    <SafeAreaView style={[styles.container, { paddingTop: topPad }]}>
      <View style={styles.header}>
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <Text style={styles.headerSubtitle}>Hoa văn & Trang trí</Text>
        </View>
        <TouchableOpacity
          onPress={() => {
            if (!menuVisible) {
      ...
      <EngagementBrideMenu
        visible={menuVisible}
        currentScreen="BrideAoDaiPattern"
        ...
        <View style={styles.grid}>
          {items.map((it) => (
            <WeddingItemCard
              ...
              name={it.name}
              image={it.image}
              isSelected={selected.includes(it._id)}
              onSelect={() => toggle(it._id)}
            />
          ))}
        </View>
        <TouchableOpacity
          style={styles.actionButton}
          onPress={() => navigation.navigate("BrideHeadscarf" as never)}
        >
