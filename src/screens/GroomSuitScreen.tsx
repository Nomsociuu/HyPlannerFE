  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: topPad }] }>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        {isLoading ? (
          <View style={styles.loadingContainer}><Text>Đang tải dữ liệu...</Text></View>
        ) : error ? (
        ...
        <TouchableOpacity style={styles.actionButton} onPress={() => navigation.navigate('GroomMaterial' as never)}>
...
const styles = StyleSheet.create({
  ...
  errorText: { color: 'red', textAlign: 'center', fontFamily: fonts.montserratMedium },
});
