...
const AlbumScreen = () => {
  ...
  const getAlbumType = (
    ...
    if (album.selections && album.selections.length > 0) {
      ...
      if (
        anySel.vestStyles ||
        anySel.vestMaterials ||
        anySel.vestColors ||
        anySel.vestLapels ||
        anySel.vestPockets ||
        anySel.vestDecorations
      )
        return "vest";
      if (
        anySel.brideEngageStyles ||
        anySel.brideEngageMaterials ||
        anySel.brideEngagePatterns ||
        anySel.brideEngageHeadwears
      )
        return "bride-engage";
      if (anySel.groomEngageOutfits || anySel.groomEngageAccessories)
        return "groom-engage";
      if (anySel.weddingToneColors || anySel.engageToneColors)
        return "tone-color";
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <TouchableOpacity
            style={[
              styles.filterChip,
              filter === "wedding-venue" && styles.filterChipActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.filterText,
                filter === "wedding-venue" && styles.filterTextActive,
              ]}
            >
              Địa điểm
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.filterChip,
              filter === "wedding-theme" && styles.filterChipActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.filterText,
                filter === "wedding-theme" && styles.filterTextActive,
              ]}
            >
              Phong cách
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.filterChip,
              filter === "wedding-dress" && styles.filterChipActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.filterText,
                filter === "wedding-dress" && styles.filterTextActive,
              ]}
            >
              Váy cưới
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.filterChip,
              filter === "vest" && styles.filterChipActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.filterText,
                filter === "vest" && styles.filterTextActive,
              ]}
            >
              Vest
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.filterChip,
              filter === "bride-engage" && styles.filterChipActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.filterText,
                filter === "bride-engage" && styles.filterTextActive,
              ]}
            >
              Áo dài
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.filterChip,
              filter === "groom-engage" && styles.filterChipActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.filterText,
                filter === "groom-engage" && styles.filterTextActive,
              ]}
            >
              Trang phục
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.filterChip,
              filter === "tone-color" && styles.filterChipActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.filterText,
                filter === "tone-color" && styles.filterTextActive,
              ]}
            >
              Tone màu
            </Text>
