...
const GroomAccessoriesDecorScreen = () => {
  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: topPad }] }>
      ...
      <GroomAccessoriesMenu visible={menuVisible} onClose={() => setMenuVisible(false)} currentScreen="GroomAccessoriesDecor" />
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <TouchableOpacity style={[styles.actionButton, isCreatingAlbum && styles.actionButtonDisabled]} onPress={handleCreateAlbum} disabled={isCreatingAlbum}>
          <Text style={styles.actionButtonText}>{isCreatingAlbum ? 'Đang tạo album...' : 'Hoàn thành'}</Text>
