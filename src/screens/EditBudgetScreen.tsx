...
export default function EditBudgetScreen() {
    ...
    const activity = useSelector((state: RootState) => state.activities.getActivityInfo.activity);
                    ...
                    ListHeaderComponent={
                        <View style={[styles.scrollView, styles.contentContainer]}>
                            ...
                            <View style={styles.section}>
                                ...
                                />
                                {activityNameError && (
                                    <Text style={{ color: 'red', marginTop: 4, marginLeft: 4 }}>{activityNameError}</Text>
                                )}
                            </View>
                            ...
                            <View style={styles.section}>
                                ...
                                <RadioButton.Group onValueChange={value => setPayer(value)} value={payer}>
                                    <View style={{ flexDirection: "row", alignItems: "center", gap: 16 }}>
                                        <View style={{ flexDirection: "row", alignItems: "center", marginRight: 16 }}>
                                            <RadioButton.Android value="groom" color="#D95D74" uncheckedColor="#D95D74" />
                                            <Text onPress={() => setPayer("groom")}>Chú rể</Text>
                                        </View>
                                        <View style={{ flexDirection: "row", alignItems: "center", marginRight: 16 }}>
                                            <RadioButton.Android value="bride" color="#D95D74" uncheckedColor="#D95D74" />
                                            <Text onPress={() => setPayer("bride")}>Cô dâu</Text>
                                        </View>
                                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                                            <RadioButton.Android value="both" color="#D95D74" uncheckedColor="#D95D74" />
