...
const AccessoriesJewelryScreen = () => {
  ...
  const { selectedJewelry, toggleJewelrySelection, saveSelections } =
    useSelection();
  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: topPad }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Phụ kiện - Trang sức</Text>
      </View>
      ...
      <View style={styles.actionButtonContainer}>
        <TouchableOpacity
          ...
          onPress={async () => {
            ...
            if (
              isInWizard &&
              currentStep === AlbumWizardStep.ACCESSORIES_JEWELRY
            ) {
              nextStep();
            }
            navigation.navigate("AccessoriesCrown" as never);
          }}
        >
          <Text style={styles.actionButtonText}>Chọn vương miện</Text>
          <ChevronLeft
            size={16}
            color="#000000"
