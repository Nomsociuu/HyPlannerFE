...
const AccessoriesCrownScreen = () => {
  ...
  const { selectedCrowns, toggleCrownSelection, saveSelections } =
    useSelection();
  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: topPad }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Phụ kiện - Vương miện</Text>
      </View>
      ...
      <View style={styles.actionButtonContainer}>
        <TouchableOpacity
          ...
          onPress={async () => {
            ...
            if (
              isInWizard &&
              currentStep === AlbumWizardStep.ACCESSORIES_CROWN
            ) {
              nextStep();
            }
            navigation.navigate("AccessoriesHairClip" as never);
          }}
        >
          <Text style={styles.actionButtonText}>Chọn kẹp tóc</Text>
          <ChevronLeft
            size={16}
            color="#000000"
