            ...
            >
                <ScrollView contentContainerStyle={styles.contentContainer} keyboardShouldPersistTaps="handled">
                    ...
                    <Text style={styles.description}>
                        Ngày cưới là một trong những khoảnh khắc ý nghĩa nhất trong cuộc
                        đời của mỗi người. Việc lập kế hoạch từ sớm không chỉ giúp bạn
                        chuẩn bị chu đáo mà còn lưu giữ những kỷ niệm đẹp trong từng
                        bước chuẩn bị. Hãy tạo một kế hoạch đám cưới để biến ngày trọng
                        đại của bạn trở nên hoàn hảo và trọn vẹn nhất.
                    </Text>
                    <View style={styles.form}>
                        ...
                        <View style={styles.inputWrapperFull}>
                            ...
                            >
                                <Text style={{ color: date ? "#333" : "#B0B0B0" }}>
                                    {date ? date.toLocaleDateString("vi-VN") : "Chọn ngày tổ chức"}
                                </Text>
                            </TouchableOpacity>
                            {showDatePicker && (
                                <DateTimePicker
                        ...
                        <TouchableOpacity style={styles.createButton} disabled={!isFormValid} activeOpacity={0.8} onPress={handleCreateWeddingEvent}>
                            <Text style={[styles.createButtonText, { opacity: isFormValid ? 1 : 0.5 }]}>Tạo kế hoạch</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </KeyboardAvoidingView>
