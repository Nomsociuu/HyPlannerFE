            ...
            >
                <ScrollView contentContainerStyle={styles.contentContainer} keyboardShouldPersistTaps="handled">
                    ...
                    <Text style={styles.description}>
                        Hãy nhập mã mời để tham gia vào kế hoạch cưới của người thân hoặc bạn bè. Cùng nhau đóng góp ý tưởng và hỗ trợ chuẩn bị cho ngày trọng đại trở nên hoàn hảo và ý nghĩa hơn!
                    </Text>
                    ...
                    <TouchableOpacity style={styles.submitButton} disabled={!isFormValid} onPress={() => setShowConfirm(true)}>
                        <Text style={[styles.submitButtonText, { opacity: isFormValid ? 1 : 0.7 }]}>Tham Gia</Text>
                    </TouchableOpacity>
                </ScrollView>
                <Portal>
