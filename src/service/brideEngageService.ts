...
export async function getAllBrideEngageMaterials(): Promise<
  ApiResponse<Material[]>
> {
  try {
    const response = await apiClient.get<ApiResponse<Material[]>>(
      `${BASE_PATH}/bride-engage/materials`
    );
    return response.data;
  } catch (error) {
...
export async function getAllBrideEngagePatterns(): Promise<
  ApiResponse<Style[]>
> {
  try {
    const response = await apiClient.get<ApiResponse<Style[]>>(
      `${BASE_PATH}/bride-engage/patterns`
    );
    return response.data;
  } catch (error) {
...
// Bride Headwears
export async function getAllBrideEngageHeadwears(): Promise<
  ApiResponse<Style[]>
> {
  try {
    const response = await apiClient.get<ApiResponse<Style[]>>(
      `${BASE_PATH}/bride-engage/headwears`
    );
    return response.data;
  } catch (error) {
